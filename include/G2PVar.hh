...
public:
    ...
    void SetVar(const char& var) { fValueC = &var; fType = kChar; }
    void SetVar(const int& var) { fValueI = &var; fType = kInt; }
    void SetVar(const short& var) { fValueS = &var; fType = kShort; }
    void SetVar(const long& var) { fValueL = &var; fType = kLong; }
    void SetVar(const float& var) { fValueF = &var; fType = kFloat; }
    void SetVar(const double& var) { fValueD = &var; fType = kDouble; }
    void SetVar(const bool& var) { fValueB = &var; fType = kBool; }
