...
double G2PPhysWISER::GetXS(double Ei, double Pf, double theta)
{
    ...
    switch (iPID) {
    case 211: // pi+
        return WISER(iZ, iA, 1, Ei, Pf, theta, fRadLen);
        break;
    case -211: // pi-
        return WISER(iZ, iA, 2, Ei, Pf, theta, fRadLen);
        break;
    case 321: // k+
        return WISER(iZ, iA, 3, Ei, Pf, theta, fRadLen);
        break;
    case -321: // k-
        return WISER(iZ, iA, 4, Ei, Pf, theta, fRadLen);
        break;
    case 2212: // p
        return WISER(iZ, iA, 5, Ei, Pf, theta, fRadLen);
        break;
    default:
        return -1;
        break;
