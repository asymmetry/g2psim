...
G2PBPM::G2PBPM() :
fBeamEnergy(2.254), fFieldRatio(0.0), fBPMAX(0.0), fBPMAY(0.0), fBPMBX(0.0), fBPMBY(0.0), fBPMAZ(-956.0e-3), fBPMBZ(-692.0e-3), fBPMARes(0.3e-3), fBPMBRes(0.3e-3), pDrift(NULL), pfGetBPM(NULL) {
    if (pG2PBPM) {
