...
G2PFlatGun::G2PFlatGun(const char *coords)
{
    ...
    if (coords_map[coords] == 2)
        pfShoot = &G2PFlatGun::ShootHCS;
...
int G2PFlatGun::ShootTCS(double *V5beam_lab, double *V5react_tr)
{
    ...
    HCS2TCS(V5beam_lab[0], V5beam_lab[2], V5beam_lab[4], Xreact_tr, Yreact_tr, Zreact_tr);
    ...
    if (fForceElastic) { // calculate elastic scattering momentum
        ...
        double theta, phi;
        TCS2HCS(V5react_tr[1], V5react_tr[3], theta, phi);
...
int G2PFlatGun::ShootHCS(double *V5beam_lab, double *V5react_tr)
{
    ...
    HCS2TCS(theta, phi, V5react_tr[1], V5react_tr[3]);
