...
fHRSAngle(0.0), fHRSMomentum(0.0), pBPM(NULL), pDrift(NULL), pGun(NULL) {
    mName["fV5beam_lab"] = fV5beam_lab;
    mLength["fV5beam_lab"] = 5;
    mName["fV5react_tr"] = fV5react_tr;
    mLength["fV5react_tr"] = 5;
