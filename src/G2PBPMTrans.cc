...
{
    //int ncoeff= 11;
    double avdat = 0.1774270E+01;
    double xmin[10] = { -0.15000E+02, -0.15000E+02, -0.18000E+02, -0.18025E+02, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00};
    double xmax[10] = {0.15000E+02, 0.15000E+02, 0.18000E+02, 0.17977E+02, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00};
    double scale[10] = {0};
    double coeff[12] = {0.11933310E-03, -0.39622177E+02, 0.65532028E+02, 0.83443993E+00, 0.25200529E+01, -0.47372710E-01, 0.78216873E-01, -0.15225040E+01, -0.13823655E+01, -0.18708317E-01, 0.26466766E-01, 0.};
    int ientry = 0;
    int i;
    ...
    // function
    double v_target_x = avdat + coeff[0] + coeff[1] * x11 + coeff[2] * x31 + coeff[3] * x11 * x21 + coeff[4] * x31 * x41 + coeff[5] * x21 + coeff[6] * x41 + coeff[7] * x21 * x31;
...
double target_y(double *x, int m)
{
    ...
    double v_target_y = avdat + coeff[0] + coeff[1] * x21 + coeff[2] * x41 + coeff[3] * x21 * x41 + coeff[4] * x42 + coeff[5] * x32 + coeff[6] * x14 + coeff[7] * x12;
...
{
    //int ncoeff= 20;
    double avdat = 0.1120523E+00;
    double xmin[10] = { -0.15000E+02, -0.15000E+02, -0.18000E+02, -0.18025E+02, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00};
    double xmax[10] = {0.15000E+02, 0.15000E+02, 0.18000E+02, 0.17977E+02, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00};
    double scale[10] = {0};
    double coeff[21] = {0.93548515E-04, -0.50340626E-01, 0.57996720E-01, -0.47768317E-02, 0.15887059E-02, 0.15522169E-01, -0.12489236E-01, -0.63411877E-02, 0.41331380E-03, -0.65351982E-03, 0.60341577E-02, 0.43789251E-03, -0.62632468E-03, -0.10483676E-03, -0.22410172E-03, 0.31096616E-03, -0.86420892E-04, 0.23729268E-04, 0.17314035E-03, -0.33568846E-04, 0.};
    int ientry = 0;
    int i;
...
double target_x(double *x, int m)
{
    ...
    double xmax[10] = {0.15000E+02, 0.15000E+02, 0.18000E+02, 0.17984E+02, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00};
    double scale[10] = {0};
    double coeff[12] = { -0.68359968E-05, -0.38941566E+02, 0.64789429E+02, -0.10212842E+01, 0.17022043E+01, 0.55410087E+00, -0.92462826E+00, 0.20685967E-01, -0.12420867E-01, -0.96249459E-02, 0.13531869E-01, 0.};
    int ientry = 0;
    int i;
...
{
    //int ncoeff=  9;
    double avdat = 0.1820886E+01;
    double xmin[10] = { -0.15000E+02, -0.15000E+02, -0.18000E+02, -0.18014E+02, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00};
    double xmax[10] = {0.15000E+02, 0.15000E+02, 0.18000E+02, 0.17987E+02, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00};
    double scale[10] = {0};
    double coeff[10] = {0.14974939E-03, -0.38482136E+02, 0.64213394E+02, 0.41052529E+00, -0.68654931E+00, -0.75923431E+00, 0.12685835E+01, 0.39473522E-01, -0.23631420E-01, 0.};
    int ientry = 0;
    int i;
...
{
    //int ncoeff= 16;
    double avdat = 0.1612694E+01;
    double xmin[10] = { -0.15000E+02, -0.15000E+02, -0.18000E+02, -0.18014E+02, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00};
    double xmax[10] = {0.15000E+02, 0.15000E+02, 0.18000E+02, 0.17987E+02, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00};
    double scale[10] = {0};
    double coeff[17] = { -0.16093630E-01, -0.38296303E+02, 0.63893883E+02, 0.89169078E-01, -0.39361799E+00, -0.38331112E+00, 0.39724809E+00, -0.47729790E-03, 0.14334489E-03, -0.23719139E-01, -0.16308597E+00, 0.51654381E+00, 0.17781040E-01, 0.44934195E-02, -0.62706377E-02, 0.14249448E-02, 0.};
    int ientry = 0;
    int i;
...
{
    //int ncoeff= 20;
    double avdat = 0.6180951E-01;
    double xmin[10] = { -0.15000E+02, -0.15000E+02, -0.18000E+02, -0.18014E+02, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00};
    double xmax[10] = {0.15000E+02, 0.15000E+02, 0.18000E+02, 0.17987E+02, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00};
    double scale[10] = {0};
    double coeff[21] = {0.43998152E-04, -0.55196326E-01, 0.65793619E-01, 0.74639604E-02, -0.60790703E-02, -0.27675012E-02, 0.61537535E-03, 0.21662402E-03, -0.34620706E-03, -0.22640435E-02, 0.28185088E-02, 0.54932359E-04, 0.25132557E-03, -0.60061220E-03, -0.23329834E-04, 0.10197179E-03, -0.15672242E-03, -0.73724154E-05, -0.11046945E-03, 0.40850369E-03, 0.};
    int ientry = 0;
    int i;
...
{
    //int ncoeff= 20;
    double avdat = 0.1156772E-02;
    double xmin[10] = { -0.15000E+02, -0.15000E+02, -0.18000E+02, -0.18014E+02, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00};
    double xmax[10] = {0.15000E+02, 0.15000E+02, 0.18000E+02, 0.17987E+02, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00};
    double scale[10] = {0};
    double coeff[21] = {0.16362627E-06, 0.69261701E-02, -0.30966168E-02, 0.19902112E-02, 0.23972974E-02, -0.11254207E+01, -0.56836046E-01, 0.37969577E+01, 0.55131987E-01, -0.44339662E+01, 0.17743859E+01, 0.32073297E-01, 0.36992654E-01, 0.18466847E+01, -0.23962980E-01, -0.34303959E-01, -0.63650475E+01, 0.73991542E+01, -0.28891239E+01, -0.93376543E-02, 0.};
    int ientry = 0;
    int i;
    ...
    // function
    double v_target_phi = avdat + coeff[0] + coeff[1] * x31 + coeff[2] * x11 * x21 + coeff[3] * x21 * x31 + coeff[4] * x11 * x41 + coeff[5] * x13 + coeff[6] * x11 * x22 + coeff[7] * x12 * x31;
...
{
    //int ncoeff= 11;
    double avdat = 0.1225998E+01;
    double xmin[10] = { -0.15000E+02, -0.15000E+02, -0.18000E+02, -0.18029E+02, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00};
    double xmax[10] = {0.15000E+02, 0.15000E+02, 0.18000E+02, 0.17972E+02, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00};
    double scale[10] = {0};
    double coeff[12] = {0.26783593E-04, -0.38496861E+02, 0.64328911E+02, 0.81722581E+00, -0.13696008E+01, -0.15153360E+01, 0.25363481E+01, -0.29490298E-01, 0.49459714E-01, -0.10544261E-01, 0.14767365E-01, 0.};
    int ientry = 0;
    int i;
...
{
    //int ncoeff= 20;
    double avdat = 0.8200859E-03;
    double xmin[10] = { -0.15000E+02, -0.15000E+02, -0.18000E+02, -0.18029E+02, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00};
    double xmax[10] = {0.15000E+02, 0.15000E+02, 0.18000E+02, 0.17972E+02, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00};
    double scale[10] = {0};
    double coeff[21] = {0.82136430E-04, -0.55444140E-01, 0.66205032E-01, -0.46876529E-02, 0.17395908E-02, 0.15340483E-01, -0.12436306E-01, -0.67721987E-02, 0.28879344E-03, 0.63901697E-02, -0.46958990E-03, 0.24596680E-03, -0.11652384E-03, 0.48341413E-03, -0.70989854E-03, -0.61864918E-03, 0.88314648E-03, 0.88900409E-03, -0.12663672E-02, 0.15426091E-04, 0.};
    int ientry = 0;
    int i;
...
{
    //int ncoeff=  9;
    double avdat = 0.2198843E+01;
    double xmin[10] = { -0.15000E+02, -0.15000E+02, -0.18000E+02, -0.18020E+02, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00};
    double xmax[10] = {0.15000E+02, 0.15000E+02, 0.18000E+02, 0.17981E+02, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00};
    double scale[10] = {0};
    double coeff[10] = {0.29159064E-03, -0.38260330E+02, 0.63978661E+02, -0.10097252E+01, 0.16923758E+01, 0.54349035E+00, -0.34861766E-01, -0.91231066E+00, 0.58452848E-01, 0.};
    int ientry = 0;
    int i;
    ...
    // function
    double v_target_x = avdat + coeff[0] + coeff[1] * x11 + coeff[2] * x31 + coeff[3] * x21 * x31 + coeff[4] * x31 * x41 + coeff[5] * x11 * x21 + coeff[6] * x21 + coeff[7] * x11 * x41;
...
{
    //int ncoeff= 14;
    double avdat = 0.2720693E+01;
    double xmin[10] = { -0.15000E+02, -0.15000E+02, -0.18000E+02, -0.18020E+02, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00};
    double xmax[10] = {0.15000E+02, 0.15000E+02, 0.18000E+02, 0.17981E+02, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00};
    double scale[10] = {0};
    double coeff[15] = { -0.22295034E-01, -0.38116352E+02, 0.63725323E+02, 0.61193955E+00, 0.17184985E+00, 0.26848450E-01, -0.38815312E-01, -0.60057771E+00, -0.65558451E+00, 0.23434667E-02, -0.67835855E-02, 0.39609550E-02, -0.27852637E+00, 0.83647746E+00, 0.};
    int ientry = 0;
    int i;
...
{
    //int ncoeff= 20;
    double avdat = 0.1141953E-02;
    double xmin[10] = { -0.15000E+02, -0.15000E+02, -0.18000E+02, -0.18020E+02, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00};
    double xmax[10] = {0.15000E+02, 0.15000E+02, 0.18000E+02, 0.17981E+02, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00};
    double scale[10] = {0};
    double coeff[21] = {0.54978864E-05, 0.43244953E-02, 0.26680531E-02, -0.17784934E-02, -0.36398428E-02, 0.25598458E-02, -0.93145981E-01, -0.11179094E+01, 0.10739040E+00, 0.38970244E+01, -0.46267352E+01, 0.18546287E+01, 0.30168299E-01, 0.14267412E+01, -0.34811120E-01, -0.50512481E+01, 0.45458049E-01, 0.59980774E+01, -0.44600341E-01, -0.23854923E+01, 0.};
    int ientry = 0;
    int i;
...
{
    //int ncoeff= 20;
    double avdat = 0.2305556E-02;
    double xmin[10] = { -0.15000E+02, -0.15000E+02, -0.18000E+02, -0.18020E+02, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00};
    double xmax[10] = {0.15000E+02, 0.15000E+02, 0.18000E+02, 0.17981E+02, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00, 0.00000E+00};
    double scale[10] = {0};
    double coeff[21] = {0.31433748E-06, -0.57134841E-01, 0.68960786E-01, 0.36454808E-02, -0.66899294E-02, -0.61481497E-02, 0.11246344E-01, 0.38622235E-03, -0.22769075E-03, -0.56440800E-04, 0.79597266E-04, 0.10659136E-03, 0.11166979E-03, -0.67178926E-05, -0.37444988E-04, 0.11103924E-03, -0.25095875E-03, 0.28138197E-03, -0.40265819E-03, 0.68492249E-04, 0.};
    int ientry = 0;
    int i;
