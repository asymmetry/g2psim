...
/////////////////////////////////////////////////////////////////////////////
bool TransportRightHRS6_LargeX0(double* pV5)
{
	...
	x_test = x_sr6_v2_ep3_(vector_jjl, &ii)*m2cm;
	y_test = y_sr6_v2_ep3_(vector_jjl, &ii)*m2cm;

	if( (x_test<-14.06) || (x_test>-8.87) || (y_test< y_min) || (y_test>y_max) )
		return false;

	//Target to 1/4 Septum, -17.12cm<x<-10.89cm, -9.9cm<y<9.9cm
	x_test = x_sr6_v2_ep4_(vector_jjl, &ii)*m2cm;
	y_test = y_sr6_v2_ep4_(vector_jjl, &ii)*m2cm;
	...
	x_test = x_sr6_v2_dext_(vector_jjl, &ii)*m2cm;
	y_test = y_sr6_v2_dext_(vector_jjl, &ii)*m2cm;
	if( (x_test<-46.19) || (x_test>46.19) || fabs(y_test) > fabs(-0.0161*x_test+12.5) )
		return false;

	//Target to Q3 entrance, circle of radius 30.0 cm
	x_test = x_sr6_v2_q3en_(vector_jjl, &ii)*m2cm;
	y_test = y_sr6_v2_q3en_(vector_jjl, &ii)*m2cm;
	if( (x_test*x_test + y_test*y_test) > (30.0*30.0) )
		return false;

	//Target to Q3 exit, circle of radius 30.0 cm  -> 28.0cm
	x_test = x_sr6_v2_q3ex_(vector_jjl, &ii)*m2cm;
	y_test = y_sr6_v2_q3ex_(vector_jjl, &ii)*m2cm;
	...
	float x_fp     = x_sr6_v2_fp_(vector_jjl,&ii);
	float theta_fp = t_sr6_v2_fp_(vector_jjl,&ii);
	float y_fp     = y_sr6_v2_fp_(vector_jjl,&ii);
	float phi_fp   = p_sr6_v2_fp_(vector_jjl,&ii);
...
bool TransportLeftHRS6_LargeX0(double* pV5)
{
	//in order to call right arm routines, need to flip y, phi 
	float vector_jjl[]={pV5[0],pV5[1],-pV5[2],-pV5[3],pV5[4]};
	bool bGoodParticle=TransportRightHRS6_LargeX0(pV5);
	if(bGoodParticle)
	{
...
/////////////////////////////////////////////////////////////////////////////
bool TransportRightHRS6(double* pV5)
{
	float vector_jjl[]={pV5[0],pV5[1],pV5[2],pV5[3],pV5[4]};
	float x_test, y_test;
	int ii=5;
...
bool TransportLeftHRS6(double* pV5)
{
	float vector_jjl[]={pV5[0],pV5[1],pV5[2],pV5[3],pV5[4]};
	float x_test, y_test;
	int ii=5;
...
/////////////////////////////////////////////////////////////////////////////////////
void ReconstructRightHRS6_LargeX0(double *pV5)
{
	float vector_jjl[]={pV5[0],pV5[1],pV5[2],pV5[3],pV5[4]};
	int ii=5,jj=1;

	/* Orthogonalize theta as JJL asks*/
	vector_jjl[1]   = vector_jjl[1] - r6_v2_txfit_(vector_jjl,&jj);
	float x_or      = vector_jjl[4];
	float delta_rec = r6_v2_delta_(vector_jjl,&ii);
	float theta_rec = r6_v2_theta_(vector_jjl,&ii);
	float phi_rec   = r6_v2_phi_(vector_jjl,&ii);
	float y_rec     = r6_v2_y00_(vector_jjl,&ii);
...
void ReconstructLeftHRS6_LargeX0(double *pV5)
{
	...
	float delta_rec = r6_v2_delta_(vector_jjl,&ii);
	float theta_rec = r6_v2_theta_(vector_jjl,&ii);
	float phi_rec   = -r6_v2_phi_(vector_jjl,&ii);	// need to flip y, phi 
	float y_rec     = -r6_v2_y00_(vector_jjl,&ii);	// need to flip y, phi 
...
/////////////////////////////////////////////////////////////////////////////////////
void ReconstructRightHRS6(double *pV5)
{
	float vector_jjl[]={pV5[0],pV5[1],pV5[2],pV5[3],pV5[4]};
	int ii=5,jj=1;
	/* Orthogonalize theta as JJL asks*/
...
void ReconstructLeftHRS6(double *pV5)
{
	//in order to call right arm routines, need to flip y, phi 
	float vector_jjl[]={pV5[0],pV5[1],-pV5[2],-pV5[3],pV5[4]};
	int ii=5,jj=1;
...
void ReconstructRightHRS6_LargeX0(double *pV5, double &delta_rec, double &theta_rec, double &phi_rec, double &y_rec)
{
	float vector_jjl[]={pV5[0],pV5[1],pV5[2],pV5[3],pV5[4]};
	int ii=5,jj=1;
	/* Orthogonalize theta as JJL asks*/
	vector_jjl[1] = vector_jjl[1] - r6_v2_txfit_(vector_jjl,&jj);
	delta_rec = r6_v2_delta_(vector_jjl,&ii);
	theta_rec = r6_v2_theta_(vector_jjl,&ii);
	phi_rec   = r6_v2_phi_(vector_jjl,&ii);
	y_rec     = r6_v2_y00_(vector_jjl,&ii);
}

void ReconstructLeftHRS6_LargeX0(double *pV5,double &delta_rec, double &theta_rec, double &phi_rec, double &y_rec)
{
	//I am using the right arm routines to do the reconstruction, JJL did not provide left arm
	//routines for the 2nd version of GDH experiment
	...
	delta_rec = r6_v2_delta_(vector_jjl,&ii);
	theta_rec = r6_v2_theta_(vector_jjl,&ii);
	phi_rec   = -r6_v2_phi_(vector_jjl,&ii);	// need to flip y, phi 
	y_rec     = -r6_v2_y00_(vector_jjl,&ii);	// need to flip y, phi 

}

void ReconstructRightHRS6(double *pV5, double &delta_rec, double &theta_rec, double &phi_rec, double &y_rec)
{
	float vector_jjl[]={pV5[0],pV5[1],pV5[2],pV5[3],pV5[4]};
	int ii=5,jj=1;
	/* Orthogonalize theta as JJL asks*/
	vector_jjl[1] = vector_jjl[1] - r6_txfit_(vector_jjl,&jj);
	delta_rec = r6_delta_(vector_jjl,&ii);
	theta_rec = r6_theta_(vector_jjl,&ii);
	phi_rec   = r6_phi_(vector_jjl,&ii);
	y_rec     = r6_y00_(vector_jjl,&ii);
}

void ReconstructLeftHRS6(double *pV5, double &delta_rec, double &theta_rec, double &phi_rec, double &y_rec)
{
	float vector_jjl[]={pV5[0],pV5[1],pV5[2],pV5[3],pV5[4]};
	int ii=5,jj=1;
	/* Orthogonalize theta as JJL asks*/
	vector_jjl[1] = vector_jjl[1] - l6_txfit_(vector_jjl,&jj);
	delta_rec = l6_delta_(vector_jjl,&ii);
	theta_rec = l6_theta_(vector_jjl,&ii);
	phi_rec   = l6_phi_(vector_jjl,&ii);
	y_rec     = l6_y00_(vector_jjl,&ii);
}
