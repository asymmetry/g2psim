...
//#ifdef TRANSFORM_DEBUG
        //printf("P_HCS2TCS(): Theta_tr=%8.4f  Phi_tr=%8.4f\n", Theta_tr/deg, Phi_tr/deg);
//#endif
...
// #ifdef TRANSFORM_DEBUG
//         printf("P_TCS2HCS(): Theta_hall=%8.4f  Phi_hall=%8.4f\n", Theta_hall/deg, Phi_hall/deg);
// #endif
...
// #endif
        ...
        // By Chao: it was 180.*deg-Phi_hall, need check
		if(sin(EndPlaneTheta_hall)<0) Phi_hall=180.*deg+Phi_hall; 
