...
float sl_r5p65_484816_sepex_(float *value, int* i);
...
float sl_r5p65_484816_q1ent_(float *value, int* i);
...
float sl_r5p65_484816_q1ext_(float *value, int* i);
...
float sl_r5p65_484816_q2ext_(float *value, int* i);
...
float sl_r5p65_484816_den_(float *value, int* i);
...
float sl_r5p65_484816_dex_(float *value, int* i);
...
float sl_r5p65_484816_q3ent_(float *value, int* i);
...
float sl_r5p65_484816_q3ext_(float *value, int* i);
...
float sl_r5p65_484816_fp_(float *value, int* i);
}
