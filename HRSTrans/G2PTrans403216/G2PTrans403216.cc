...
#include "Fwd_l5p77_403216.h"
#include "Bwd_l5p77_403216.h"

#include "G2PTrans403216.hh"

using namespace S403216;

const float m2cm = 100.0;
const float m2mm = 1000.;
const double kDEG = 3.14159265358979323846 / 180.0;

G2PTrans403216::G2PTrans403216()
{
...
int G2PTrans403216::TransLeftHRS(double *pV5, double *PlanePosX, double *PlanePosY)
{
...
int G2PTrans403216::TransRightHRS(double *pV5, double *PlanePosX, double *PlanePosY)
{
...
void G2PTrans403216::ReconLeftHRS(double *pV5)
{
    float vector_jjl[] = {float(pV5[0]), float(pV5[1]), float(pV5[2]), float(pV5[3]), float(pV5[4])};
    int ii = 5;
...
void G2PTrans403216::ReconRightHRS(double *pV5)
{
