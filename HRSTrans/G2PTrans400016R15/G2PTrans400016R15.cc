...
#include "Fwd_l5p77_400016R15.h"
#include "Bwd_l5p77_400016R15.h"

#include "G2PTrans400016R15.hh"

#define CORRECTION_ORDER -1

using namespace S400016R15;

const float m2cm = 100.0;
const float m2mm = 1000.;
const double kDEG = 3.14159265358979323846 / 180.0;

G2PTrans400016R15::G2PTrans400016R15() {
...
bool G2PTrans400016R15::TransLeftHRS(double* pV5) {
...
bool G2PTrans400016R15::TransRightHRS(double* pV5) {
...
void G2PTrans400016R15::ReconLeftHRS(double* pV5) {
    float vector_jjl[] = {pV5[0], pV5[1], pV5[2], pV5[3], pV5[4]};
    int ii = 5;
...
void G2PTrans400016R15::ReconRightHRS(double* pV5) {
...
void G2PTrans400016R15::FPCorrLeft(const double* V5tg, double* V5fp) {
...
void G2PTrans400016R15::FPCorrRight(const double* V5tg, double* V5fp) {
#if CORRECTION_ORDER == 0
    V5fp[0] += (-5.91123e-03);
    V5fp[1] += (-6.76146e-05);
    V5fp[2] -= (-1.89684e-02);
