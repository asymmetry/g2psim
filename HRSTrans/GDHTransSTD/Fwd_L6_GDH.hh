...
float sl_sl_ep3_(float *value, int* i);
...
float sl_sl_ep4_(float *value, int* i);
...
float sl_sl_ep5_(float *value, int* i);
...
float sl_sl_ep6_(float *value, int* i);
...
float sl_sl_ep7_(float *value, int* i);
...
float sl_sl_q1ex_(float *value, int* i);
...
float sl_sl_dent_(float *value, int* i);
...
float sl_sl_dext_(float *value, int* i);
...
float sl_sl_q3en_(float *value, int* i);
...
float sl_sl_q3ex_(float *value, int* i);
...
float sl_sl_fp_(float *value, int* i);
}
