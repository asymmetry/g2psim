...
float sl_sr_ep3_(float *value, int* i);
...
float sl_sr_ep4_(float *value, int* i);
...
float sl_sr_ep5_(float *value, int* i);
...
float sl_sr_ep6_(float *value, int* i);
...
float sl_sr_ep7_(float *value, int* i);
...
float sl_sr_q1ex_(float *value, int* i);
...
float sl_sr_dent_(float *value, int* i);
...
float sl_sr_dext_(float *value, int* i);
...
float sl_sr_q3en_(float *value, int* i);
...
float sl_sr_q3ex_(float *value, int* i);
...
float sl_sr_fp_(float *value, int* i);
}
