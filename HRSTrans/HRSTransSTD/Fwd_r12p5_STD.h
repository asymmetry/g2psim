...
float sl_r12p5_q1ex_(float *Value, int* i);
...
float sl_r12p5_dent_(float *Value, int* i);
...
float sl_r12p5_dext_(float *Value, int* i);
...
float sl_r12p5_q3en_(float *Value, int* i);

float x_r12p5_q3ex_(float *Value, int* i);
float t_r12p5_q3ex_(float *Value, int* i);
float y_r12p5_q3ex_(float *Value, int* i);
float p_r12p5_q3ex_(float *Value, int* i);
float sl_r12p5_q3ex_(float *Value, int* i);
...
float sl_r12p5_fp_(float *Value, int* i);
}
