...
//                 function
				...
				float v_r5p65_txfit                             =avdat
							+coeff[  0]    
							+coeff[  1]*x11
							;

				return v_r5p65_txfit                             ;
}
