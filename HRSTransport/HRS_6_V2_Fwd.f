...
c
     ...
     7  +coeff(  7)    *x21    *x41    
     8  +coeff(  8)    *x21*x31        
      y_sr6_v2_ep4    =y_sr6_v2_ep4    
     9  +coeff(  9)*x11        *x41    
c
      return
      end
      function p_sr6_v2_ep4    (x,m)
      dimension x(m)
      dimension xmin(10),xmax(10),scale(10),xmean(10)
      dimension coeff( 51)
      data ncoeff/ 50/
...
c
     ...
     7  +coeff(  7)    *x21    *x41    
     8  +coeff(  8)    *x21*x31        
      y_sr6_v2_ep5    =y_sr6_v2_ep5    
     9  +coeff(  9)*x11        *x41    
     1  +coeff( 10)*x11    *x31        
c
      return
      end
      function p_sr6_v2_ep5    (x,m)
      dimension x(m)
      dimension xmin(10),xmax(10),scale(10),xmean(10)
      dimension coeff( 51)
      data ncoeff/ 50/
