...
namespace S484816R20
{
    ...
    float l_r5p65_ep11_q1en                     (float *x,int m){
        int ncoeff= 43;
    ...
    //                 function
        ...
        float v_l_r5p65_ep11_q1en                     =avdat
            +coeff[  0]                    
            +coeff[  1]    *x21            
            +coeff[  2]        *x31        
            +coeff[  3]            *x41    
            ...
            +coeff[  7]    *x22    *x41    
        ;
        v_l_r5p65_ep11_q1en                     =v_l_r5p65_ep11_q1en                     
            +coeff[  8]                *x51
            +coeff[  9]            *x41*x51
            +coeff[ 10]*x11*x21            
            +coeff[ 11]    *x21    *x41    
    ...
    float l_r5p65_ep13_q1                       (float *x,int m){
        int ncoeff= 68;
    ...
    //                 function
        ...
        float v_l_r5p65_ep13_q1                       =avdat
            ...
            +coeff[  7]            *x41*x51
        ;
        v_l_r5p65_ep13_q1                       =v_l_r5p65_ep13_q1                       
            +coeff[  8]    *x22    *x41    
            +coeff[  9]    *x21    *x41    
            +coeff[ 10]*x11*x21            
            +coeff[ 11]*x11*x21    *x41    
    ...
    float l_r5p65_ep14_q1ex                     (float *x,int m){
        int ncoeff= 82;
    ...
    //                 function
        ...
        float v_l_r5p65_ep14_q1ex                     =avdat
            +coeff[  0]                    
            +coeff[  1]        *x31        
            +coeff[  2]            *x41    
            +coeff[  3]                *x51
            ...
            +coeff[  7]            *x41*x51
        ;
        v_l_r5p65_ep14_q1ex                     =v_l_r5p65_ep14_q1ex                     
            +coeff[  8]    *x22    *x41    
            +coeff[  9]*x11*x21    *x41    
            +coeff[ 10]    *x21    *x43    
            +coeff[ 11]*x11*x21            
    ...
    float l_r5p65_ep23_den                      (float *x,int m){
        int ncoeff= 90;
    ...
    //                 function
        ...
        float v_l_r5p65_ep23_den                      =avdat
            +coeff[  0]                    
            +coeff[  1]    *x21            
            +coeff[  2]        *x31        
            +coeff[  3]            *x41    
            ...
            +coeff[  7]        *x31*x41    
        ;
        v_l_r5p65_ep23_den                      =v_l_r5p65_ep23_den                      
            +coeff[  8]            *x42    
            +coeff[  9]            *x41*x51
            +coeff[ 10]*x11*x21            
            +coeff[ 11]    *x22    *x41    
    ...
    float l_r5p65_ep25_dex                      (float *x,int m){
        int ncoeff= 52;
    ...
    //                 function
        ...
        float v_l_r5p65_ep25_dex                      =avdat
            +coeff[  0]                    
            +coeff[  1]    *x21            
            +coeff[  2]            *x41    
            +coeff[  3]                *x51
            ...
            +coeff[  7]    *x21        *x51
        ;
        v_l_r5p65_ep25_dex                      =v_l_r5p65_ep25_dex                      
            +coeff[  8]*x11        *x41    
            +coeff[  9]    *x23            
            +coeff[ 10]    *x23*x31        
            +coeff[ 11]    *x21*x31        
    ...
    float l_r5p65_ep27_q3en                     (float *x,int m){
        int ncoeff= 59;
    ...
    //                 function
        ...
        float v_l_r5p65_ep27_q3en                     =avdat
            +coeff[  0]                    
            +coeff[  1]    *x21            
            +coeff[  2]                *x51
            +coeff[  3]*x11                
            ...
            +coeff[  7]*x11        *x41    
        ;
        v_l_r5p65_ep27_q3en                     =v_l_r5p65_ep27_q3en                     
            +coeff[  8]    *x23            
            +coeff[  9]    *x23*x31        
            +coeff[ 10]            *x41    
            +coeff[ 11]    *x21*x31        
    ...
    float l_r5p65_ep30_q3ex                     (float *x,int m){
        int ncoeff= 59;
    ...
    //                 function
        ...
        float v_l_r5p65_ep30_q3ex                     =avdat
            +coeff[  0]                    
            +coeff[  1]    *x21            
            +coeff[  2]                *x51
            +coeff[  3]*x11                
            ...
            +coeff[  7]    *x23            
        ;
        v_l_r5p65_ep30_q3ex                     =v_l_r5p65_ep30_q3ex                     
            +coeff[  8]    *x23*x31        
            +coeff[  9]            *x41    
            +coeff[ 10]    *x21*x31        
            +coeff[ 11]    *x21        *x51
    ...
    float l_r5p65_ep5                           (float *x,int m){
        int ncoeff=  8;
    ...
    float l_r5p65_ep7                           (float *x,int m){
        int ncoeff= 45;
    ...
    float l_r5p65_fp                            (float *x,int m){
        int ncoeff= 60;
