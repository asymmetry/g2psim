...
//                 function
    ...
    float v_txfit_sl5p65_400016                     =avdat
        +coeff[  0]    
        +coeff[  1]*x11
        ;

    return v_txfit_sl5p65_400016                     ;
}
...
//                 function
    ...
    float v_delta_sl5p65_400016                     =avdat
        +coeff[  0]                    
        +coeff[  1]*x11                
        +coeff[  2]*x12                
        +coeff[  3]*x11*x21            
        ...
        +coeff[  7]    *x21    *x41    
    ;
    v_delta_sl5p65_400016                     =v_delta_sl5p65_400016                     
        +coeff[  8]    *x21        *x51
        +coeff[  9]        *x31    *x51
        +coeff[ 10]        *x31        
        +coeff[ 11]*x11    *x31        
...
//                 function
    ...
    float v_theta_sl5p65_400016                     =avdat
        +coeff[  0]                    
        +coeff[  1]*x11                
        +coeff[  2]    *x21            
        +coeff[  3]*x12                
        ...
        +coeff[  7]    *x21    *x41    
    ;
    v_theta_sl5p65_400016                     =v_theta_sl5p65_400016                     
        +coeff[  8]    *x23            
        +coeff[  9]*x11*x21*x31        
        +coeff[ 10]                *x51
        +coeff[ 11]        *x31    *x51
...
//                 function
    ...
    float v_phi_sl5p65_400016                       =avdat
        +coeff[  0]                    
        +coeff[  1]        *x31        
        +coeff[  2]            *x41    
        +coeff[  3]*x11                
        ...
        +coeff[  7]            *x42    
    ;
    v_phi_sl5p65_400016                       =v_phi_sl5p65_400016                       
        +coeff[  8]*x11    *x31        
        +coeff[  9]    *x21*x31        
        +coeff[ 10]*x11        *x41    
        +coeff[ 11]    *x22            
...
//                 function
    ...
    float v_y00_sl5p65_400016                       =avdat
        +coeff[  0]                    
        +coeff[  1]        *x31        
        +coeff[  2]            *x41    
        +coeff[  3]*x11                
        ...
        +coeff[  7]    *x21*x31        
    ;
    v_y00_sl5p65_400016                       =v_y00_sl5p65_400016                       
        +coeff[  8]*x11        *x41    
        +coeff[  9]    *x21    *x41    
        +coeff[ 10]*x11*x21            
        +coeff[ 11]    *x22            
