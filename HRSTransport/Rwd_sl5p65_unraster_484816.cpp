...
//                 function
    ...
    float v_txfit_sl5p65_484816_unrastered          =avdat
        +coeff[  0]    
        +coeff[  1]*x11
        ;

    return v_txfit_sl5p65_484816_unrastered          ;
}
...
//                 function
    ...
    float v_delta_sl5p65_484816_unrastered          =avdat
        +coeff[  0]                    
        +coeff[  1]*x11                
        +coeff[  2]*x12                
        +coeff[  3]*x11*x21            
        ...
        +coeff[  7]    *x22            
    ;
    v_delta_sl5p65_484816_unrastered          =v_delta_sl5p65_484816_unrastered          
        +coeff[  8]        *x32        
        +coeff[  9]    *x21    *x41    
        +coeff[ 10]*x13                
        +coeff[ 11]*x11*x22            
    ...
    return v_delta_sl5p65_484816_unrastered          ;
}
...
//                 function
    ...
    float v_theta_sl5p65_484816_unrastered          =avdat
        +coeff[  0]                    
        +coeff[  1]*x11                
        +coeff[  2]    *x21            
        +coeff[  3]            *x41    
        ...
        +coeff[  7]*x11    *x31        
    ;
    v_theta_sl5p65_484816_unrastered          =v_theta_sl5p65_484816_unrastered          
        +coeff[  8]    *x21*x31        
        +coeff[  9]*x11*x21*x31        
        +coeff[ 10]    *x21*x32        
        +coeff[ 11]*x11*x22            
    ...
    return v_theta_sl5p65_484816_unrastered          ;
}
...
//                 function
    ...
    float v_phi_sl5p65_484816_unrastered            =avdat
        +coeff[  0]                    
        +coeff[  1]        *x31        
        +coeff[  2]            *x41    
        +coeff[  3]*x11                
        ...
        +coeff[  7]            *x42    
    ;
    v_phi_sl5p65_484816_unrastered            =v_phi_sl5p65_484816_unrastered            
        +coeff[  8]*x11    *x31        
        +coeff[  9]    *x21*x31        
        +coeff[ 10]*x11        *x41    
        +coeff[ 11]    *x21    *x41    
    ...
    return v_phi_sl5p65_484816_unrastered            ;
}
